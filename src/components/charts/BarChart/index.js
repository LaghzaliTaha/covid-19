...
import {
  BarChart, Bar, CartesianGrid, XAxis, YAxis, LabelList, Legend,
} from 'recharts';
  ...
  defs = (activeChartConfig) => (
    <defs>
      <linearGradient x1="100%" y1="0%" x2="50%" y2="180%" id="linearGradient-1">
        <stop stopColor={activeChartConfig.reportTable.colorStart} offset="0%" />
        <stop stopColor={activeChartConfig.reportTable.colorStop} offset="100%" />
      </linearGradient>
      <linearGradient x1="100%" y1="0%" x2="50%" y2="180%" id="linearGradient-rem">
      ...
      <linearGradient
        ...
        id="linearGradient-2"
      >
        <stop stopColor={activeChartConfig.regionCoverage.colorStart} offset="0%" />
        <stop stopColor={activeChartConfig.regionCoverage.colorStop} offset="100%" />
      </linearGradient>
    </defs>
  )
    const {
          ...
          <Grid container spacing={8}>
            ...
            <Grid item xs={10}>
              ...
              >
                ...
                <XAxis tickLine={false} dataKey="name" stroke={COLORS.ATHENS_GRAY} tick={{ fill: PALETTE.BLUE_TWO }} />
                <YAxis
                  tickLine={false}
                ...
                >
                  <LabelList
                    ...
                    formatter={(value) => (value.length > 0
                      ? formatNum(value[1] - value[0]) : formatNum(value))}
                    position="top"
                  />
                </Bar>
                { !sales && (
